...
void handleRoot() {
    ...
    html += F("<button class=\"test-btn\" onclick=\"addTest('temp_hum')\"><svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"><path d=\"M10 13V5a1.5 1.5 0 0 0-3 0v8a3 3 0 1 0 3 0z\"/><path d=\"M17 8l2.83 2.83a4 4 0 1 1 -5.66 0z\"/></svg><span>Temp+Hum</span></button>");
    html += F("<button class=\"test-btn\" onclick=\"addTest('motion')\"><svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"><path d=\"M12 12h.01\"/><path d=\"M8 8a5.657 5.657 0 0 0 0 8\"/><path d=\"M16 16a5.657 5.657 0 0 0 0-8\"/><path d=\"M5 5a10 10 0 0 0 0 14\"/><path d=\"M19 19a10 10 0 0 0 0-14\"/></svg><span>Motion</span></button>");
    html += F("<button class=\"test-btn\" onclick=\"addTest('contact')\"><svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"><rect x=\"3\" y=\"3\" width=\"7\" height=\"18\" rx=\"1\"/><rect x=\"14\" y=\"3\" width=\"7\" height=\"18\" rx=\"1\"/></svg><span>Contact</span></button>");
    html += F("<button class=\"test-btn\" onclick=\"addTest('light')\"><svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"><circle cx=\"12\" cy=\"12\" r=\"4\"/><path d=\"M12 2v2m0 16v2M4.93 4.93l1.41 1.41m11.32 11.32l1.41 1.41M2 12h2m16 0h2M4.93 19.07l1.41-1.41m11.32-11.32l1.41-1.41\"/></svg><span>Light</span></button>");
    ...
    html += F("<button class=\"test-btn\" onclick=\"addTest('update')\"><svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"><path d=\"M23 4v6h-6\"/><path d=\"M1 20v-6h6\"/><path d=\"M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15\"/></svg><span>Update Values</span></button>");
