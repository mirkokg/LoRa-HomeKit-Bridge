...
void handleRoot() {
    ...
    html += F("<button class=\"test-btn\" onclick=\"addTest('temp_hum')\"><svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"><path d=\"M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0z\"/></svg><span>Temp+Hum</span></button>");
